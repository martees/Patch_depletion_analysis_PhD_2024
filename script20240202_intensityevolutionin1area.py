    ...
    if remove_peaks:
        ...
        for i in range(1, len(first_derivative) - 1):
            ...
            if first_derivative[i] > 0:
                ...
                first_derivative[i + 1] = avg_intensities[i + 2] - avg_intensities[last_true_index]  # out of bound check?
...
def interactive_intensity_plot(image_path, start, end, quarter, x_range=None, y_range=None, analysis_size=10):
    ...
    def click_event(event):
        ...
        if event.button is MouseButton.LEFT and event.inaxes == middle_ax:
            ...
            curr_intensity_drops = find_drops(selected_pixel_intensities, -0.1)
...
if __name__ == "__main__":
    ...
    interactive_intensity_plot(path, start_time, end_time, 2, x_limits, y_limits, analysis_size=10)
